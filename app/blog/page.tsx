...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Le journal MRD Studio", description: "Conseils concrets pour construire une présence digitale visible et performante.", url: "/blog", type: "website" },
};

export default function BlogPage() {
  return (
    <>
      <JsonLd data={{ "@context": "https://schema.org", "@type": "Blog", name: "Le journal MRD Studio", url: "https://mrd-studio.fr/blog", publisher: { "@id": "https://mrd-studio.fr/#business" }, blogPost: blogArticles.map(([slug, title]) => ({ "@type": "BlogPosting", headline: title, url: `https://mrd-studio.fr/blog/${slug}` })) }} />
      <Header />
      <main>
